...
Claude Opus 4、GPT-4o、Gemini Ultra——它們在推理、理解、生成代碼方面都已達到令人驚嘆的水準。問題從來不是 LLM 不夠聰明。
...
- 專案存在 6 個月以上、有累積的架構決策和踩坑記錄的代碼庫
- 多人協作、知識在不同人腦中分散的團隊
- 每次重新開啟 AI 對話都要「重新解釋背景」的工程師

不適合：
- 全新專案、尚無歷史的代碼庫（冷啟動期效益低）
- 純粹探索性、一次性的 AI 對話
...
Brain 的定位是：**針對工程代碼庫的結構化長期記憶，零外部依賴，與 git 工作流原生整合。**
