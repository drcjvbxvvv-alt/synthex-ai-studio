"""
project_brain/pipeline/worker.py — Auto Knowledge Pipeline 背景 Worker
...
使用方式：
    from project_brain.pipeline.worker import PipelineWorker, start_global_worker
...
from project_brain.pipeline.executor import KnowledgeExecutor
from project_brain.pipeline.signal import Signal, SignalQueue
